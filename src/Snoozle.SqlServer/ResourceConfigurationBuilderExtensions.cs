...
namespace Snoozle.SqlServer
{
    ...
    {
        private static readonly Regex _tableNameRegex = new Regex(@"^[\p{L}_][\p{L}\p{N}@$#_]{0,127}$");
    ...
    {
        private static readonly Regex _columnNameRegex = new Regex(@"^[a-zA-Z_][a-zA-Z0-9_ ]*$");
